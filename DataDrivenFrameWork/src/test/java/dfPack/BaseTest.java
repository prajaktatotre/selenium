...
public class BaseTest {
	 ...
	 /*
	  * if you face stale element exception
	  *  WebDriverWait wait=new WebDriverWait(driver, 10);
	  ...
	  public void initialise(){
		  ...
		  if(prop==null){
				...
				File projectConfigFile = new File(System.getProperty("user.dir")+"/src/test/resources/projectconfig.properties");
	  ...
	  public void refreshPage(){
		  eTest.log(LogStatus.INFO, "Refreshing the page");
		  driver.navigate().refresh();
		  eTest.log(LogStatus.INFO, "Refreshed successfully");
	  }
	  ...
	  public boolean doLogin(String Username,String Password) {
		  ...
		  if(getTitle().equals(prop.getProperty("AfetrLoginPage"))) {
			  eTest.log(LogStatus.INFO, "Title Matched and pasing the test case");
			  return true;
	  ...
	  public String getTitle(){
		  eTest.log(LogStatus.INFO, "Getting title of the page");
